...
(function(factory) {
	...
	$.validator.addMethod("isTel", function(value, element) {
		return this.optional(element) || checkTel(value)
	}, "请正确填写您的电话号码");
	$.validator.addMethod("isIamge", function(value, element) {
		return this.optional(element) || isImage(value)
	}, "请上传图片");
...
function checkTel(value) {
	var isTel = /^((0\d{2,3})-)?(\d{7,8})(-(\d{3,}))?$/.test(value);
	if(!isTel) {
		return false;
	}
	return true;
...
function checkMobile(value) {
	...
	var mobile = /^0?1[3|4|5|8|7][0-9]\d{8}$/.test(value);
	if(!mobile) {
		return false;
	}
	return true;
