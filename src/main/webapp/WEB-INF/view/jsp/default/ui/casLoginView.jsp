...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/common/bootstrap-3.3.5-dist/css/bootstrap.min.css"/>
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/common/font-awesome-4.7.0/css/font-awesome.css" />
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/common/layer-v2.4/layer/skin/layer.css" />
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/animate/animate.css" />
...
<!-- 	<body class="gray-bg"> -->
<body class="skin-blur-timg" id="skin-blur-timg">
		<div class="middle-box text-center loginscreen animated fadeInDown">
			...
			<form:form method="post" class="login-form" role="form" id="fm1" commandName="${commandName}" htmlEscape="true" onsubmit="checkForm()">
				...
				<form:errors ><input type="hidden" id="error" name="error" value="error"></form:errors>
		...
		<script src="${pageContext.request.contextPath}/common/layer-v2.4/layer/layer.js" charset="utf-8"></script>
		<script src="${pageContext.request.contextPath}/common/validate/jquery.validate.min.js" charset="utf-8"></script>
		<script src="${pageContext.request.contextPath}/common/validate/additional-methods.js" charset="utf-8"></script>
		<script src="${pageContext.request.contextPath}/js/apiManager.js" charset="utf-8"></script>
		<script src="${pageContext.request.contextPath}/common/localization/messages_zh.min.js" charset="utf-8"></script>
		<script src="${pageContext.request.contextPath}/common/layer-v2.4/layer/layer.js"  charset="utf-8"></script>
		<script >
			window.onload=function(){
				var localstyle=get('style', 1000 * 60 * 60 * 4);
				console.log(localstyle);
				$("body").attr('id',localstyle)
			};
		</script>
